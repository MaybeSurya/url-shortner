...
const spec = {
  ...
  SITE_NAME: str({ example: "Surya's URL Shortening Service", default: "Surya's URL Shortening Service" }),
  DEFAULT_DOMAIN: str({ example: "sury.cc", default: "localhost:3000" }),
  ...
  MAIL_FROM: str({ default: "", example: "Surya's URL Shortening Service <support@sury.cc>" }),
  ...
  OIDC_BUTTON_TEXT: str({ default: "Sign in with SSO" }),
